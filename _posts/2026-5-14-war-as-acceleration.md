...
* The Rejection of Democracy: Yarvin argues that democracy is a failed experiment, an inefficient "Type 1" error that produces bureaucracy instead of results. He proposes replacing it with "Patchwork": a global landscape of thousands of small, sovereign city-states.

* The CEO-State: In this dream of a state, the citizen is replaced by the customer, and the politician is replaced by a CEO. These enclaves would be run with the cold efficiency of a tech startup, unburdened by the "social contracts" of the past.

* The Thiel Influence: Peter Thiel’s support for these ideologies stems from a belief that freedom and democracy are no longer compatible. By funding candidates and technologies that challenge the "Cathedral" (the established media and government complex), he facilitates the transition from a nation-state to a corporate frontier.
